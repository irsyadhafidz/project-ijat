<?php
	...
	class Dashboard extends CI_Controller{
		public function index(){
			...
			$data['total_customer'] = $this->db->query("SELECT * FROM customer")->num_rows()-1;
			$data['total_transaksi'] = $this->db->query("SELECT * FROM transaksi WHERE status_rental = 'Selesai'")->num_rows()-1;
