                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-footer-widget">
                            ...
                            <div class="widget-body">
                                ...
                                <p>Berkendara mewah dan tanpa batas bersama Elite Transport. Temukan armada modern dan layanan unggul kami. Prestise dan keanggunan terwujud dalam setiap perjalanan. Selamat datang di pengalaman berkendara yang istimewa.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-footer-widget">
                            ...
                            <div class="widget-body">
                                ...
                                <ul class="get-touch">
                                    <li><i class="fa fa-map-marker"></i>Tumpak, Rt 23/03, Ngawu, Kec. Playen, Kabupaten Gunung Kidul, Daerah Istimewa Yogyakarta 55861, Indonesia</li>
                                    <li><i class="fa fa-whatsapp"></i> +62 822 2973 0429</li>
...
Copyright &copy; <script>document.write(new Date().getFullYear());</script> All rights reserved | SISTEM INFORMASI PENYEWAAN MOBIL ELITE TRANSPORT</a>
