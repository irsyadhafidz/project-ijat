...
<head>
    ...
    <title>SISTEM INFORMASI PENYEWAAN MOBIL ELITE TRANSPORT</title>
                    ...
                    <div class="col-lg-8 d-none d-xl-block">
                        <nav class="mainmenu alignright">
                            <ul style="">
                                ...
                                <li><a href="<?php echo base_url('customer/data_mobil') ?>">Daftar Mobil</a></li>
                                ...
                                <?php if($this->session->userdata('nama')) { ?>
                                    ...
                                    <li><a href="<?php echo base_url('auth/ganti_password') ?>">Ubah Password</a></li>
                                ...
                                <?php }else{ ?>
                                    <li><a href="<?php echo base_url('register') ?>">Registrasi</a></li>
                                        ...
                                        <li class="about-btn" style="width: 125px;text-align:center"><a href="<?php echo base_url('auth/login') ?>">Login</a></li>
