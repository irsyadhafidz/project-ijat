					...
					<table class="table">
						<?php foreach($transaksi as $tr) : ?>
							...
							<tr>
								<th>Penyedia</th>
								<td>: </td>
								<td>CV. Elite Transport Jogja</td>
							</tr>
			...
			<div class="card" style="margin-top: 110px">
				...
				<div class="card-body">
					...
					<ul class="list-group list-group-flush">
							...
							<li class="list-group-item font-bold">BANK BRI 47254527858875 a/n CV. Elite Transport Jogja</li>
							<li class="list-group-item font-bold">BANK BNI 52688163445110 a/n CV. Elite Transport Jogja</li>
							<li class="list-group-item font-bold">BANK MANDIRI 7255341414123 a/n CV. Elite Transport Jogja</li>
