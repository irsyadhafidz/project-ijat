    ...
    <section id="slideslow-bg" style="background:url('<?php echo base_url() ?>assets/assets_shop/img/banner.jpg" alt="JSOFT">')">
        <div class="container">
            <div class="row">
                    ...
                    <div class="slideshowcontent">
                        <div class="display-table">
                            <div class="display-table-cell">
                                ...
                                <p style="font-size: 11pt;font-style: normal;color:white;">Selamat datang di Elite Transport, solusi penyewaan mobil pilihan untuk perjalanan mewah dan profesional.<br>
                                    Nikmati armada terbaru, layanan pelanggan unggul, dan pengalaman berkendara yang tak terlupakan.</p>
                                <br><a href="<?php echo base_url('auth/login') ?>">

                                    <button class="book-now-btn">Sewa Sekarang</button> </a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="single-funfact">
                                    ...
                                    <div class="funfact-content">
                                        <p><span class="counter"><?php echo $total_transaksi ?></span>+</p>
